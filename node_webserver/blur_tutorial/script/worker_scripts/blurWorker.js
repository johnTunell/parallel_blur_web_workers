...
function messageHandler(e) {
    ...
    switch (messageType) {
        ...
        case ("newBorder"):
            var imageBorderLeft = new Uint8ClampedArray(e.data.imageBorderLeft,0, 1600);
            var imageBorderRight = new Uint8ClampedArray(e.data.imageBorderRight,0, 1600);
            ...
            var borderLeftBuf = new Uint8ClampedArray(borderLeft,0, 1600).buffer;
            var borderRightBuf = new Uint8ClampedArray(borderRight,0, 1600).buffer;
