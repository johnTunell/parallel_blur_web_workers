...
function sendBlurTask(worker, i, chunkWidth, isFirst, isLast, isIterationBlur, iteration, remainder) {
    ...
    const borderStartXright = isLast ? ((i + 1) * chunkWidth) - 1 + remainder: ((i + 1) * chunkWidth);
